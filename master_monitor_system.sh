...
1) printf "Restarting the email server on %s view Error Logs if necessary! \n" "$date"
   nohup /home/omrapp/Desktop/Jugaad_testV1/bin/python3 /home/omrapp/Desktop/Jugaad_testV1/email_functionV1.py 2>> /home/omrapp/Desktop/reporthash/SYSLOGS_ADMIN_ONLY/appserverlogs/emailserver_logs.txt &
...
1) printf "Restarting the Gunicorn production server on %s view Error Logs if necessary! \n" "$date"
   nohup /home/omrapp/Desktop/Jugaad_testV1/bin/python3 /home/omrapp/Desktop/Jugaad_testV1/bin/gunicorn --pythonpath=/home/omrapp/Desktop/Jugaad_testV1/bin/python3 --bind 127.0.0.1:5000 --workers 16 app:app 2>> /home/omrapp/Desktop/reporthash/SYSLOGS_ADMIN_ONLY/appserverlogs/gunicorn_logs.txt &
   ;;
